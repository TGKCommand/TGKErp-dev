...
export function renderWarranty() {
  ...
  return '<div style="display:flex;gap:16px;margin-bottom:16px">'
    ...
    + '<div style="font-size:10px;color:#8a9ba8;text-transform:uppercase;letter-spacing:.06em">Open Claims</div>'
    + '<div style="font-size:24px;font-weight:800;color:#ef4444">' + open + '</div>'
    + '</div>'
    + '<div style="background:#fff;border-radius:8px;border:1px solid #e2e8f0;padding:16px;flex:1">'
    + '<div style="font-size:10px;color:#8a9ba8;text-transform:uppercase;letter-spacing:.06em">Total Claims</div>'
    + '<div style="font-size:24px;font-weight:800;color:#1a1c1e">' + claims.length + '</div>'
    + '</div>'
    + '</div>'
