...
export function renderBOMs() {
  ...
  return '<div style="display:grid;grid-template-columns:320px 1fr;gap:16px;height:calc(100vh - 140px)">'
    ...
    + (!selectedPn
      ...
      : '<div style="padding:16px;border-bottom:1px solid #e2e8f0">'
        ...
        + '<div style="overflow-y:auto;flex:1">'
        + (bom.length === 0
          ? '<div style="padding:40px;text-align:center;color:#8a9ba8">No BOM components found</div>'
