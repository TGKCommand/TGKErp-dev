...
export function renderPurchases() {
  ...
  const totalOpen = pos.filter(p => p.status !== 'Received' && p.status !== 'Cancelled')
  ...
  return '<div style="display:flex;gap:16px;margin-bottom:16px">'
    ...
    + '<div style="font-size:10px;color:#8a9ba8;text-transform:uppercase;letter-spacing:.06em">Open POs</div>'
    + '<div style="font-size:24px;font-weight:800;color:#E07B28">' + pos.filter(p=>p.status==='Ordered'||p.status==='Partial').length + '</div>'
    + '</div>'
    + '<div style="background:#fff;border-radius:8px;border:1px solid #e2e8f0;padding:16px;flex:1">'
    + '<div style="font-size:10px;color:#8a9ba8;text-transform:uppercase;letter-spacing:.06em">Open Value</div>'
    + '<div style="font-size:24px;font-weight:800;color:#2ABFAA">$' + totalOpen.toFixed(2) + '</div>'
    + '</div>'
    + '<div style="background:#fff;border-radius:8px;border:1px solid #e2e8f0;padding:16px;flex:1">'
    + '<div style="font-size:10px;color:#8a9ba8;text-transform:uppercase;letter-spacing:.06em">Total POs</div>'
    + '<div style="font-size:24px;font-weight:800;color:#1a1c1e">' + pos.length + '</div>'
    + '</div>'
    + '</div>'
